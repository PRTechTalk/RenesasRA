...
void SSD1331_enableScrolling(_Bool enable);
...
static const unsigned char FontLookup [][5] =
{
   ...
   {0x0, 0x12, 0x3F, 0x2D, 0x12}, // | 0x7C 124 | - ó ÿêîñò_ ñèìâîëà Bluetooth
   { 0x00, 0x41, 0x36, 0x08, 0x00 },   // } 0x7D 125
   //{ 0x08, 0x04, 0x08, 0x10, 0x08 },   // ~ 0x7E 126
   { 0x00, 0x45, 0x7C, 0x45, 0x00 },   // ~ 0x7E 126 ~ - ó ÿêîñò_ óêðà¿íñüêî¿ ë_òåðè "¿"
